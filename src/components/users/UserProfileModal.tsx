...
export const UserProfileModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-900/60 backdrop-blur-xs overflow-y-auto">
      <div className="bg-white rounded-[4px] shadow-2xl border border-slate-200 w-full max-w-2xl overflow-hidden animate-slide-down my-auto">
        
        {/* Header Bar */}
        <div className="px-6 py-4 bg-gradient-to-r from-brand-navy via-brand-blue to-blue-900 text-white flex items-center justify-between border-b border-blue-950 shadow-xs">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-white/10 rounded-[3px] text-amber-300">
            ...
            <div>
              <h2 className="text-sm sm:text-base font-bold tracking-tight text-white flex items-center gap-2">
                ...
                <span className="text-[10px] font-bold px-2 py-0.2 bg-amber-400 text-slate-950 rounded">
                  @{activeUser.username}
                </span>
              </h2>
        ...
        {/* Tab Navigation */}
        <div className="flex border-b border-slate-200 bg-slate-50/80 px-6 pt-2 gap-1 text-xs">
          <button
            type="button"
            onClick={() => {
            ...
            className={`px-4 py-2.5 font-bold flex items-center gap-2 border-b-2 transition-all cursor-pointer ${
              activeTab === 'PROFILE'
                ? 'border-brand-blue text-brand-blue bg-white rounded-t'
        ...
        <div className="p-6 space-y-4 max-h-[75vh] overflow-y-auto text-xs text-slate-800">
          ...
          {/* Notifications */}
          {errorMessage && (
            <div className="p-3 bg-red-50 border-l-4 border-brand-red text-red-700 flex items-center gap-2 rounded-r-[3px] text-xs animate-shake">
          ...
          {successMessage && (
            <div className="p-3 bg-emerald-50 border-l-4 border-emerald-600 text-emerald-800 flex items-center gap-2 rounded-r-[3px] text-xs">
          ...
          {activeTab === 'PROFILE' && (
            <form onSubmit={handleSaveProfile} className="space-y-5">
                ...
                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4">
                  ...
                  <div className="relative group shrink-0">
                    <img
                      ...
                      alt={activeUser.name}
                      className="w-20 h-20 sm:w-24 sm:h-24 rounded-full object-cover border-4 border-white shadow-md ring-2 ring-brand-blue/30"
                    />
                    <button
                      type="button"
                      onClick={() => fileInputRef.current?.click()}
                      className="absolute inset-0 bg-slate-900/60 rounded-full text-white flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer text-[10px] font-bold"
                    >
                  ...
                  <div className="space-y-2 text-center sm:text-left flex-1">
                    ...
                    <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2">
                      <button
                        ...
                        onClick={() => fileInputRef.current?.click()}
                        className="px-3.5 py-1.5 bg-brand-blue hover:bg-brand-blue-dark text-white font-bold rounded-[3px] shadow-sm transition-all flex items-center gap-1.5 cursor-pointer text-xs"
                      >
                        {isUploadingAvatar ? (
                          <>
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold rounded-[3px] border border-slate-300 transition-colors text-xs"
                      >
                  ...
                  <div className="grid grid-cols-6 sm:grid-cols-12 gap-2 pt-1">
                    {PRESET_AVATARS.map((preset, idx) => (
                      <button
                        ...
                        className={`relative rounded-full overflow-hidden aspect-square border-2 transition-transform hover:scale-110 cursor-pointer ${
                      ...
                      >
                        ...
                        {avatarUrl === preset && (
                          <div className="absolute inset-0 bg-brand-blue/40 flex items-center justify-center text-white">
              ...
              {/* Account Details */}
              <div className="bg-white p-4 border border-slate-200 rounded-[4px] space-y-3 shadow-2xs">
                <span className="block font-bold text-slate-800 text-xs uppercase tracking-wider">
                  Thông Tin Tài Khoản
                </span>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 bg-slate-50 border border-slate-300 rounded-[3px] font-bold text-slate-900 focus:bg-white focus:outline-none focus:ring-1 focus:ring-brand-blue"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 bg-slate-100 border border-slate-200 rounded-[3px] font-mono font-bold text-slate-500 cursor-not-allowed"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-1.5 px-3 py-2 bg-slate-100 border border-slate-200 rounded-[3px] text-slate-700 font-semibold text-xs">
              ...
              <div className="flex items-center justify-end gap-2 pt-2 border-t border-slate-200">
                <button
                  type="button"
                  onClick={handleClose}
                  className="px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold rounded-[3px] border border-slate-300 transition-colors cursor-pointer"
                >
                  Đóng
                </button>
                <button
                  ...
                  className="px-5 py-2 bg-brand-blue hover:bg-brand-blue-dark text-white font-bold rounded-[3px] shadow transition-all flex items-center gap-1.5 cursor-pointer"
                >
          ...
          {activeTab === 'PASSWORD' && (
            <form onSubmit={handleChangePassword} className="space-y-4">
              ...
              <div className="bg-blue-50/50 p-4 border border-blue-200 rounded-[4px] space-y-1.5">
              ...
              <div className="space-y-3.5 bg-slate-50 p-4 border border-slate-200 rounded-[4px]">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full pl-3 pr-10 py-2 bg-white border border-slate-300 rounded-[3px] font-medium text-slate-900 focus:outline-none focus:ring-1 focus:ring-brand-blue"
                    />
                    <button
                      type="button"
                  ...
                  {newPass && (
                    <div className="mt-2 space-y-1">
                      ...
                      <div className="h-1.5 w-full bg-slate-200 rounded-full overflow-hidden flex gap-0.5">
                        <div className={`h-full flex-1 transition-all ${passStrength >= 1 ? (passStrength <= 1 ? 'bg-red-500' : passStrength <= 3 ? 'bg-amber-500' : 'bg-emerald-500') : 'bg-transparent'}`} />
                        <div className={`h-full flex-1 transition-all ${passStrength >= 2 ? (passStrength <= 3 ? 'bg-amber-500' : 'bg-emerald-500') : 'bg-transparent'}`} />
                        <div className={`h-full flex-1 transition-all ${passStrength >= 3 ? (passStrength <= 3 ? 'bg-amber-500' : 'bg-emerald-500') : 'bg-transparent'}`} />
                        <div className={`h-full flex-1 transition-all ${passStrength >= 4 ? 'bg-emerald-500' : 'bg-transparent'}`} />
                      </div>
                    </div>
                  )}
                </div>
              ...
              <div className="flex items-center justify-end gap-2 pt-2 border-t border-slate-200">
                ...
                <button
                  ...
                  className="px-5 py-2 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-[3px] shadow transition-all flex items-center gap-1.5 cursor-pointer disabled:opacity-50"
                >
          ...
          {activeTab === 'SIGNATURE' && (
            <div className="space-y-4">
              ...
              <div className="bg-slate-50 p-4 border border-slate-200 rounded-[4px] space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    type="button"
                    onClick={clearCanvas}
                    className="px-2.5 py-1 text-[11px] bg-white hover:bg-red-50 text-slate-600 hover:text-brand-red font-semibold rounded border border-slate-300 transition-colors flex items-center gap-1 cursor-pointer"
                  >
                ...
                <div className="border-2 border-dashed border-slate-300 bg-white rounded-[4px] p-1 flex items-center justify-center">
                  <canvas
                    ref={canvasRef}
                    width={520}
                    height={160}
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="px-4 py-1.5 bg-brand-blue hover:bg-brand-blue-dark text-white font-bold rounded-[3px] shadow transition-all flex items-center gap-1.5 cursor-pointer disabled:opacity-40"
                  >
              ...
              <div className="p-4 bg-slate-50 border border-slate-200 rounded-[4px] space-y-3">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-3">
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-800 font-bold rounded-[3px] border border-slate-300 transition-colors flex items-center gap-1.5 cursor-pointer"
                  >
                ...
                {signatureUrl && (
                  <div className="pt-2">
                    ...
                    <div className="p-2 bg-white border border-slate-200 rounded inline-block">
