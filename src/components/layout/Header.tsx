      ...
      <div className="flex items-center justify-between px-4 lg:px-6 h-16">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="relative" ref={profileRef}>
            ...
            >
              <img
                src={activeUser.avatar || `https://ui-avatars.com/api/?name=${encodeURIComponent(activeUser.name)}&background=1e40af&color=fff`}
                alt={activeUser.name}
              ...
              <div className="absolute right-0 mt-2 w-64 bg-white border border-slate-200 rounded-[3px] shadow-2xl z-50 overflow-hidden animate-slide-down">
                ...
                <div className="p-2 space-y-1">
                  <button
                    ...
                    className="w-full flex items-center gap-2.5 px-3 py-2 text-xs text-slate-700 hover:text-brand-blue hover:bg-blue-50/70 font-semibold rounded-[3px] text-left transition-colors duration-150 cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="w-full flex items-center gap-2.5 px-3 py-2 text-xs text-slate-700 hover:text-amber-700 hover:bg-amber-50/70 font-semibold rounded-[3px] text-left transition-colors duration-150 cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="w-full flex items-center gap-2.5 px-3 py-2 text-xs text-slate-700 hover:text-emerald-700 hover:bg-emerald-50/70 font-semibold rounded-[3px] text-left transition-colors duration-150 cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="w-full flex items-center gap-2.5 px-3 py-2 text-xs text-brand-red hover:bg-red-50 font-bold rounded-[3px] text-left transition-colors duration-150 cursor-pointer"
                  >
